...
public class CrashSimulatorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        status.setText(
                "DUMMY CRASH MODE\n\n" +
                "Simulasi crash sedang ditampilkan.\n" +
                "Tidak benar-benar menghentikan aplikasi."
        );
